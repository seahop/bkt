...
const docTemplate = `{
    ...
    "paths": {
        "/api/access-keys": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Access key and secret key (secret shown only once)",
                        "schema": {
                            "type": "object"
                        }
                    },
        ...
        "/api/access-keys/stats": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Access key statistics",
                        "schema": {
                            "type": "object"
                        }
                    },
        ...
        "/api/auth/logout": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Optional refresh token to also revoke",
                        "name": "request",
                        "in": "body",
                        "schema": {
                            "type": "object"
        ...
        "/api/buckets/{name}/folders/move": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Source and destination folder prefixes",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Move result with count of moved objects",
                        "schema": {
                            "type": "object"
                        }
                    },
        ...
        "/api/buckets/{name}/object-versions": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/buckets/{name}/objects": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of objects with count",
                        "schema": {
                            "type": "object"
                        }
                    },
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Upload result with ETag and content type",
                        "schema": {
                            "type": "object"
                        }
                    },
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.MoveObjectRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Move result with updated object",
                        "schema": {
                            "type": "object"
                        }
                    },
        ...
        "/api/buckets/{name}/objects/presign": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Object key and expiry",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "url and expires_at",
                        "schema": {
                            "type": "object"
                        }
                    },
        ...
        "/api/buckets/{name}/objects/rename": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Source key and new filename",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.RenameObjectRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Rename result with updated object",
                        "schema": {
                            "type": "object"
                        }
                    },
        ...
        "/api/buckets/{name}/objects/{key}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Set to 'true' to force download attachment",
                        "name": "download",
                        "in": "query"
                    }
                ],
        ...
        "/api/groups/{id}/policies/{policy_id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/policies/users/{user_id}/attach": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/policies/users/{user_id}/detach/{policy_id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/policies/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated policy fields",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.S3Configuration"
                            }
                        }
                    },
                    "403": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateS3ConfigRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/s3-configs/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "S3 Configuration ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated S3 configuration fields",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateS3ConfigRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/users/{id}/access-keys/{key_id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "api.presignRequest": {
            ...
            "properties": {
                "expires_in": {
                    "description": "seconds; default 900, capped at 604800",
                    "type": "integer"
                },
                "key": {
                    "type": "string"
        ...
        "models.AccessKey": {
            ...
            "properties": {
                ...
                "name": {
                    "description": "Human label to tell keys apart",
                    "type": "string"
                },
                "read_only": {
        ...
        "models.Bucket": {
            ...
            "properties": {
                ...
                "lifecycle": {
                    "description": "Lifecycle holds the bucket's lifecycle configuration as JSON (see\nLifecycleConfig); nil = no lifecycle rules.",
                    "type": "string"
                },
                "name": {
                    "type": "string"
                ...
                "quota_bytes": {
                    "description": "QuotaBytes caps the total size of CURRENT objects in the bucket\n(version storage is not counted). 0 = unlimited.",
                    "type": "integer"
                },
                "region": {
                    "type": "string"
                ...
                "s3_config_id": {
                    "description": "Optional: specific S3 config to use",
                    "type": "string"
                },
                "storage_backend": {
                ...
                "webhook_url": {
                    "description": "Webhook event notifications: POSTed as JSON to WebhookURL for the event\ntypes in WebhookEvents (csv of \"created\",\"removed\"). Empty URL = off.",
                    "type": "string"
                }
            }
        },
        ...
        "models.Object": {
            ...
            "properties": {
                ...
                "metadata": {
                    "description": "x-amz-meta-* user metadata (JSON map, nullable)",
                    "type": "string"
                },
                "sha256": {
                ...
                "tags": {
                    "description": "S3 object tags (JSON map, nullable)",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
                ...
                "version_id": {
                    "description": "VersionID of the CURRENT version (\"\" = written while unversioned, the\nS3 \"null\" version). Non-current versions live in object_versions.",
                    "type": "string"
                }
            }
        },
        ...
        "models.User": {
            ...
            "properties": {
                ...
                "sso_email": {
                    "description": "Email from SSO (may differ from Email)",
                    "type": "string"
                },
                "sso_id": {
